define(['tools/lang/morphology/Verb', 'tools/lang/morphology/Themizer', 'tools/lang/morphology/Paradigm'], function(Verb, Themizer, Paradigm){
	beforeEach(function(){
		this.addMatchers({
	...
	describe('Irregular verbs paradigm', function(){
		it('andàr', function(){
			...
			expect(paradigm).toBeJsonEqual(expected);
		});

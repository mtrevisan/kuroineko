...
define(['tools/lang/phonology/Word', 'tools/data/StringHelper', 'tools/lang/phonology/Hyphenator', 'tools/lang/phonology/hyphenatorPatterns/vec'], function(Word, StringHelper, Hyphenator, pattern_vec){
	...
	var getIndexOfStressThemeT3 = (function(){
		...
		var stressIndices = [
			...
			/^(albregà|(anpli|dol[sŧ]i|falsi|forti|glori|klasi|morti|petri|sakri|scari|spe[sŧ]i)f([ei]g|ik)à|defraudà|desfabr([ei]g|ik)à|desfogonà|deskankarà|deskapità|deskavedà|deskodegà|deskomodà|despeko[lƚ]à|despe[nt]o[lƚ]à|despetenà|despetorà|desp[ei]go[lƚ]à|despolv[ae]rà|destego[lƚ]à|destenp[ae]rà|dest[ae]rm[ei]nà|destoko[lƚ]à|destuà|dexba[fv][ae]rà|dexbigo[lƚ]à|dexbingo[lƚ]à|dexboxemà|dexbo[sŧ]o[lƚ]à|dexbu[sx]o[lƚ]à|dexdà|dexganb[ae]rà|dexlanegà|dexmanegà|dexmaskarà|dexm[eo]ntegà|dexmestegà|dexmunegà|dexnaxo[lƚ]à|dexnià|dexnonbo[lƚ]à|dexn[ou]à|dexri[sŧ]o[lƚ]à|dexv[ae]r[xdđ]enà|dexvià|sfad[ei]gà|farnet([ei]g|ik)à|farnetegà|formigo[lƚ]à|inaxeà|inbra[sŧ]o[lƚ]à|inbrià|infrapo[lƚ]à|ingravidà|inkreà|inkrosto[lƚ]à|inkro[sŧ]o[lƚ]à|inprià|inskato[lƚ]à|inske[lƚ]etrà|inspaxemà|inspeà|inspirità|instaurà|intrapo[lƚ]à|intrinsekà|introità|kalki[dđx]o[lƚ]à|konmixerà|konpanegà|konpenetrà|konsid[ae]rà|kontaminà|mo[lr]tip[lr]([ei]g|ik)à|parte[sŧ]ipà|p[ae]rmudarà|p([ae]r|re)se[gk]uità|piovexinà|posti[sŧ]ipà|predestenà|predomenà|presostatà|pre[dđx]ud([ei]g|ik)à|pre[sŧ]ipità|prevarikà|profumegà|pronostegà|regroà|represtinà|respexo[lƚ]à|restaurà|rin[đx]ovenà|salvadegà|skomunegà|stenografà|strao(rden|blig|kup)à|tartufo[lƚ]à|tramuà|tramudarà|xbixigo[lƚ]à|xbonigo[lƚ]à|xgarofo[lƚ]à|xmo[lƚ][ei]xinà)$/,

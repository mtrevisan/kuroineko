...
define(['tools/lang/phonology/Word', 'tools/data/StringHelper', 'tools/lang/phonology/Hyphenator', 'tools/lang/phonology/hyphenatorPatterns/vec'], function(Word, StringHelper, Hyphenator, pattern_vec){
	...
	var getIndexOfStressThemeT3 = (function(){
		...
		var stressIndices = [
			...
			/^(skonpa[jɉ]inà|strasaé|barafuxo[lƚ]à|desfrab([ei]g|ik)à|desfrego[lƚ]à|destr[ei]go[lƚ]à|dexabi[lƚ]ità|dexbramegà|dexbraxo[lƚ]à|dexgr[ae]ndenà|(identi|kuanti|senpli|skarni)f([ei]g|ik)à|inv[ae]rigo[lƚ]à|in[dđx]eñato[lƚ]à|[jɉ]egomarà|konglom[ae]rà|kongratu[lƚ]à|[lƚ]ustrisimà|malkreà|malprategà|metamorfi[dđx]à|rekapito[lƚ]à|rinprov[ae]rà|skonbuso[lƚ]à|skonpaxenà|spa[sŧ]aorà|sprexud([ei]g|ik)à|stramuà|stra[ns]uà|straseko[lƚ]à|xbarbato[lƚ]à|xmo[lr]tip[lr]([ei]g|ik)à|[sŧ]entrifugà)$/,

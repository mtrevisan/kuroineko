...
define(['tools/lang/phonology/Word', 'tools/lang/phonology/Syllabe', 'tools/lang/phonology/Syllabator', 'tools/data/StringHelper'], function(Word, Syllabe, Syllabator, StringHelper){
	...
	var getIndexOfStressThemeT3 = (function(){
		...
		var suffixes = [
			...
			/(ux|kl)e$/, /(en|[fpsŧ]et)u$/, /tub$/, /(ne|[dlmpsŧ]i|[im]o)d$/, /xof$/, /([obdđflmnñsŧvx]e|di|ro|iu)g$/, /(da|xe|[dlnt]i|du)k$/, /([fk]e|mi|[aecdđgnñpvx]o|[bglpstx]u)l$/,
			/([gs]a|[nrsx]e|di|go)m$/, /[ust]en$/, /([sŧ]i|ko|ku)p$/, /([cdfkmvx]a|[abdđgjɉklmsvx]e|([bgr]|em)o|e[bk])r$/, /([aeoubdlmpsŧvx]i|[flmp]u)t$/, /(do|ne)v$/, /aux$/,

			/[st]inu$/, /(bi|fa|fru|si)tu$/, /(av[ei]|bri|kui)d$/, /r[bp]e[đx]$/, /graf$/, /(([aiu]n|[aeiunrs]t|[aiour]p|[uebgt]r)e|(a[lt]|bl|dr|it)i|([aio]l|er)o|ifu)g$/,
			...
			/dustri$/, /aufrag$/, /(kre[sŧ]|stok)ol$/, /vinkol$/, /vixil$/, /platin$/, /tinpan$/
		];

require(['tools/lang/phonology/Hypenator'], function(Hypenator){
	...
	QUnit.test('Hypenator', function(assert){
		...
		var expected = [
			...
			'kad-mio', 'e-kid-na', 'dre-ŧar', 'a-dria', 'felds-pa-to', 'ad-vo-ka-ŧion', 'af-gan', 'flú-i-do', 're-flè-so', 'af-nio', 'fru-to',
			'xa-fran', 'af-ta', 'ftà-le-go', 'a-míg-da-la', 'stag-fla-ŧion', 'glò-ria', 'kú-gluf', 'dòg-ma', 'gra-do', 'ne-gro', 'xgrén-xer',
			'tungs-te-no', 'angs-trom', 'ek-bò-le-go', 'ek-dè-me-go', 'bi-ŧi-kle-ta', 'klà-se-go', 'drak-ma', 'kmèr', 'ak-ne', 'knò-so', 'kre-a',
			...
			'cix-bar', 'kax-dra-fo', 'xga-jo', 'xɉan-sar', 'xla-ka', 'bux-lar', 'e-go-ix-mo', 'max-na-da', 'xne-gar', 'xña-kar', 'o-rex-ña-ŧa',
			'xra-ɉo-nar', 'xvo-dar', 'kon-tro-e-xen-pio', 'kon-tro-in-di-kar', 'èks-tra', 'eks-tra-so-lar', 'eks-tra-eu-ro-pè-o', 'eks-tra-u-te-rin',
			'eks-tra-os-pe-da-lièr', 'pa-ra-ban-ka-rio', 'pa-ra-e-ti-mo-lò-xe-go', 'pa-ra-ò-ci', 'pa-ra-ur-ti', 'op-to-e-le-trò-ne-go',
			'op-to-gra-fí-a', 'an-ti-lèr-xe-go', 'an-ti-a-tò-me-go', 'dis-pnè-a', 'dis-pnòi-ko', 'bio-lò-xe-go', 'bio-as-tro-nàu-ta',

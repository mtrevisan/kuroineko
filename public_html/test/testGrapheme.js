require(['tools/lang/phonology/Grapheme'], function(Grapheme){
	...
	QUnit.test('grapheme to phone conversion test - eterophonic sequences', function(){
	...
	QUnit.test('grapheme to phone conversion test - hyatus', function(){
	...
	QUnit.test('grapheme to phone conversion test - combinatorial variants', function(){
	...
	QUnit.test('grapheme to phone conversion test - single graphemes', function(){
	...
	QUnit.test('grapheme to phoneme conversion test - single graphemes', function(){
	...
	QUnit.test('phone to grapheme conversion test', function(){

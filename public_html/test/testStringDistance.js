require(['tools/data/StringDistance', 'tools/lang/phonology/Phone'], function(StringDistance, Phone){
	...
	QUnit.test('damerau-levenshtein - arzento', function(){
		equal(StringDistance.getStructuralDistance('ardento', 'ardent', defaultCosts), 0.14285714285714285);
		...
		equal(StringDistance.getStructuralDistance('ardent', 'ardento', defaultCosts), 0.07142857142857142);
		...
		equal(StringDistance.getStructuralDistance('ardent', 'radent', {insertion: 1, deletion: 2, substitution: 0.5, transposition: 0.4}), 0.03333333333333333);
		...
		equal(StringDistance.getStructuralDistance('ard͡zento', 'arðentu', defaultCosts), 0.05555555555555555);
		...
		equal(StringDistance.getStructuralDistance('ardento', 'arðentu', defaultCosts), 0.07142857142857142);
		...
		equal(StringDistance.getStructuralDistance('ardento', 'arjento', defaultCosts), 0.03571428571428571);
		...
		equal(StringDistance.getStructuralDistance('ard͡zento', 'ard͡ʒento', defaultCosts), 0.027777777777777776);
		...
		equal(StringDistance.getStructuralDistance('ardento', 'ardento', defaultCosts), 0);
